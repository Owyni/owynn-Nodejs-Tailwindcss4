    ...
    <div className="min-h-screen">
      <main>
        <div className="flex flex-1 justify-between items-center">
          <div className="pl-30 pr-10 pt-20 pb-10 max-w-2xl">
            ...
            <p className="p-2 text-lg text-gray-600 mb-6">
              This is a simple webpage built with Next.js and Tailwind CSS. Explore
        ...
        <div className="bg-white/30 backdrop-blur-md shadow-lg rounded-xl px-8 py-4 flex items-center font-sans justify-center max-w-7xl w-full mx-auto mt-6">
          <section className="p-8 my-12 mx-auto max-w-3xl">
