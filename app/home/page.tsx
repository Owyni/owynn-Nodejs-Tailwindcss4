        ...
        <div className="flex items-center max-w-7xl w-full mx-auto justify-between backdrop-blur-md px-8 py-4 flex-col md:flex-row">
          <div className="">
            ...
            <p className="p-2 text-lg text-gray-600 mb-6 text-shadow-sm max-w-2xl">
              This is a simple webpage built with Next.js and Tailwind CSS.{" "}
              <br></br> Explore the content and enjoy the design!
            </p>
          </div>
          <Image
            width={700}
        ...
        <div className="bg-white/30 backdrop-blur-md shadow-lg rounded-xl px-8 py-4 flex items-center font-sans justify-center max-w-7xl w-full mx-auto mt-6">
          <section className="p-8 my-12 mx-auto max-w-2xl">
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              I'm a Systems Engineering student from Mexico who enjoys meeting
              new people, discussing contemporary issues, and embracing new
              experiences. I'm fluent in both English and Spanish. I'm
              passionate about fitness and spend a lot of time at the gym, but
              I'm just as comfortable focusing on long-term challenges that
              require persistence and patience. I'm always ready to face new
              obstacles and excited to connect with you!
            </p>
          </section>
        </div>
        <Footer />
